...
<?php
            if ( $row['Liked'] == "liked" ) {
?>
<input type="button" src="images/like.jpg" id="like_user<?php echo $id;?>" value="Like" class="Liked" onClick="UpdateRecord(<?php echo $id;?>,'like');" style="display:none;"/>
<input type="button" src="images/unlike.jpg" id="unlike_user<?php echo $id;?>" value="Unlike" class="Unlike" onClick="UpdateRecord(<?php echo $id;?>,'unlike');"style="display:block;"/>
...
if ( $row['Liked'] == "unlike" ) {
?>
  <input type="button"  src="images/unlike.jpg" id="unlike_user<?php echo $id;?>" value="Unlike" class="Unlike" onClick="UpdateRecord(<?php echo $id;?>,'unlike');" style="display:none;"/>
  <input type="button"  src="images/like.jpg" id="like_user<?php echo $id;?>" value="Like" class="Liked" onClick="UpdateRecord(<?php echo $id;?>,'like');" style="display:block;"/>
